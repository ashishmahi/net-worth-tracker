# Requirements (archived): Personal Wealth Tracker — v1.7

> **Archived:** 2026-05-02 at milestone close. The root `.planning/REQUIREMENTS.md` was removed so the next milestone starts clean — run **`/gsd-new-milestone`** to define **v1.8+** requirements.
