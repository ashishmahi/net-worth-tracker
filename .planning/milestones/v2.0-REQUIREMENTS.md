# Requirements (archived): Personal Wealth Tracker — v2.0

> **Archived:** 2026-05-03 at milestone close. The root `.planning/REQUIREMENTS.md` was removed so the next milestone starts clean — run **`/gsd-new-milestone`** to define requirements for **v2.1+**.
...
---
*Requirements defined: 2026-05-02 · archived: 2026-05-03*
