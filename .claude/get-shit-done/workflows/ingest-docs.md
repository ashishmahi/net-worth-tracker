...
```bash
INIT=$(node "/home/user/net-worth-tracker/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/user/net-worth-tracker/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
