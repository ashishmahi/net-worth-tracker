...
<reference>
@/home/user/net-worth-tracker/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/net-worth-tracker/.claude/get-shit-done/references/user-profiling.md` to load:
