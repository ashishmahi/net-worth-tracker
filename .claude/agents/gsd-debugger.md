...
<required_reading>
@/home/user/net-worth-tracker/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/home/user/net-worth-tracker/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/net-worth-tracker/.claude
                  → checks /home/user/net-worth-tracker/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/net-worth-tracker/.claude/get-shit-done
                  → writes to /home/user/net-worth-tracker/.claude/get-shit-done/hooks/
...
@/home/user/net-worth-tracker/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/user/net-worth-tracker/.claude/get-shit-done/references/common-bug-patterns.md
