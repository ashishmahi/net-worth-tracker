...
<execution_context>
@/home/user/net-worth-tracker/.claude/get-shit-done/workflows/manager.md
...
Read and execute `/home/user/net-worth-tracker/.claude/get-shit-done/workflows/analyze-dependencies.md` end-to-end.
