...
Reference full template: `/home/user/net-worth-tracker/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/net-worth-tracker/.claude/get-shit-done/templates/state.md`.
