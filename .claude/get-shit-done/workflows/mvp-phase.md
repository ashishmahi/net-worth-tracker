...
<required_reading>
@/home/user/net-worth-tracker/.claude/get-shit-done/references/user-story-template.md
@/home/user/net-worth-tracker/.claude/get-shit-done/references/spidr-splitting.md
@/home/user/net-worth-tracker/.claude/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/user/net-worth-tracker/.claude/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/user/net-worth-tracker/.claude/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/user/net-worth-tracker/.claude/get-shit-done/references/spidr-splitting.md`. Briefly:
