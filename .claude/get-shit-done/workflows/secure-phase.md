...
```
Agent(
  prompt="Read /home/user/net-worth-tracker/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/net-worth-tracker/.claude/get-shit-done/templates/SECURITY.md`
