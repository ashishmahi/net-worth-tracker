...
```markdown
Read /home/user/net-worth-tracker/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/net-worth-tracker/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/net-worth-tracker/.claude/agents/gsd-ui-checker.md for instructions.
