...
Use template from `/home/user/net-worth-tracker/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/user/net-worth-tracker/.claude/get-shit-done/templates/UI-SPEC.md`
