...
```
Agent(
  prompt="Read /home/user/net-worth-tracker/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/net-worth-tracker/.claude/get-shit-done/templates/VALIDATION.md`
