...
```bash
INIT=$(node "/home/user/net-worth-tracker/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/user/net-worth-tracker/.claude/get-shit-done/templates/spec.md.
