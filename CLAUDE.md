...
- Requirements: *live* `.planning/REQUIREMENTS.md` is created/updated by `/gsd-new-milestone` (between milestones it may be absent). Archives: e.g. `.planning/milestones/v2.2-REQUIREMENTS.md`, `v1.6-REQUIREMENTS.md`, `v1.5-REQUIREMENTS.md`, …
...
### Next step
**v2.2** is archived ([`milestones/v2.2-ROADMAP.md`](.planning/milestones/v2.2-ROADMAP.md)). There is **no** live `.planning/REQUIREMENTS.md` until **`/gsd-new-milestone`**. Run the app with `npm run dev`; tests: `npm test`. Status: `/gsd-progress`.
